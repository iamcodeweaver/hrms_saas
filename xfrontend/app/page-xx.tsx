    ...
    <Box>
      ...
      <Box id="faq" sx={{ py: 10, bgcolor: "#f8fafc" }}>
        <Container maxWidth="md">
          ...
          {faqs.map((faq, index) => (
            <Accordion key={index} sx={{ mb: 1, borderRadius: 2, boxShadow: "none", border: "1px solid #e2e8f0", "&:before": { display: "none" } }}>
      ...
      <Box id="contact" sx={{ py: 10 }}>
        <Container maxWidth="sm">
          ...
          <Card sx={{ borderRadius: 3, border: "1px solid #e2e8f0", boxShadow: "0 4px 20px rgba(0,0,0,0.05)" }}>
            <CardContent sx={{ p: 4 }}>
